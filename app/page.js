                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-2">
                          {isMealAvailableToday(item) ? (
                            ...
                            <span className="badge badge-secondary">Nicht verfügbar</span>
                          )}
                        </div>
                        <div className="flex space-x-2">
                          <button
                      ...
                      <div className="flex space-x-3">
                        {isMealAvailableToday(item) ? (
                          ...
                          <div className="flex-1 flex items-center justify-center space-x-2 bg-red-50 border border-red-200 rounded-lg px-6 py-3 text-red-700">
                            <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                            </svg>
                            <span className="font-medium">Nur {item.day.charAt(0).toUpperCase() + item.day.slice(1)} verfügbar</span>
                          </div>
                        )}
                      </div>
                    </div>
